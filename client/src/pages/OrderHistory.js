...
function OrderHistory() {
  ...
  <div className="container mx-auto px-4">
    <h2 className="mb-8 text-5xl font-bold font-heading">Order History for {user.firstName} {user.lastName}</h2>
    <p className="mb-14 text-lg text-gray-500">Recent Orders dolor sit amet consectutar</p>
    <div className="mb-12 py-8 px-8 md:px-20 bg-white">
      ...
      <div className="flex flex-wrap -mx-4 mb-8">
        ...
        <div className="w-full lg:w-5/6 px-4">
          <div className="flex mb-16">
            <div className="mr-auto">
              <h3 className="text-xl font-bold font-heading">BRILE water filter carafe</h3>
              <p className="text-gray-500">Maecenas 0.7 commodo sit</p>
            </div>
            <span className="text-2xl font-bold font-heading text-blue-300">$29.89</span>
          </div>
          <div className="flex flex-wrap -mx-10">
            <div className="w-full lg:w-auto px-10 mb-6 lg:mb-0">
              <h4 className="mb-6 font-bold font-heading">Ordered on</h4>
      ...
      <div className="flex flex-wrap -mx-4 mb-8">
        <div className="w-full lg:w-1/6 px-4 mb-8 lg:mb-0">
          <div className="flex items-center justify-center h-72 bg-gray-100">
            <img className="h-64 object-cover" src="yofte-assets/images/basketball.png" alt=""/>
          </div>
        </div>
        <div className="w-full lg:w-5/6 px-4">
          <div className="flex mb-16">
            <div className="mr-auto">
              <h3 className="text-xl font-bold font-heading">NIKE Basketball Ball</h3>
      ...
      <div className="flex flex-wrap -mx-4 mb-8">
        <div className="w-full lg:w-1/6 px-4 mb-8 lg:mb-0">
          <div className="flex items-center justify-center h-72 bg-gray-100">
            <img className="h-64 object-cover" src="yofte-assets/images/backpack.png" alt=""/>
          </div>
        </div>
        <div className="w-full lg:w-5/6 px-4">
          <div className="flex mb-16">
            <div className="mr-auto">
              <h3 className="text-xl font-bold font-heading">Backpack Travel</h3>
              <p className="text-gray-500">Maecenas commodo libero ut molestie dictum. Morbi placerat eros id porttitor sagittis.</p>
            </div>
            <span className="text-2xl font-bold font-heading text-blue-300">$29.89</span>
          </div>
          <div className="flex flex-wrap -mx-10">
